...
const Favorites = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-black p-4">
      <h2 className="text-3xl font-bold mb-6 text-center">Manage Favorites</h2>
      ...
      <input
        ...
        className="p-3 mb-4 border border-gray-300 rounded-lg w-full text-lg focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-300"
      />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {currentItems.map((fav) => (
          ...
          <div
            key={fav._id}
            className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 relative group border-l-8 border-l-yellow-500"
          >
            <input
              type="checkbox"
